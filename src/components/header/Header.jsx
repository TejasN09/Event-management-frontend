...
const Header = () => {
    ...
    return (
        <nav className="top-0 bg-no-repeat relative w-full">
            <svg xmlns="http://www.w3.org/2000/svg" transform="scale(1 -1)" width="100%" height="50%" viewBox="0 0 1440 220">
                <path fill="#8B008B" fill-opacity="1" d="M0,64L48,69.3C96,75,192,85,288,106.7C384,128,480,160,576,144C672,128,768,64,864,69.3C960,75,1056,149,1152,154.7C1248,160,1344,96,1392,64L1440,32L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z" >
                </path></svg>
